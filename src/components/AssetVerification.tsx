          ...
          <div className="bg-white rounded-2xl max-w-xl w-full shadow-2xl relative overflow-hidden flex flex-col max-h-[90vh] text-xs">
            ...
            <div className="bg-slate-900 text-white p-5 flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-[10px] text-slate-300">Scan hardware asset labels with standard camera device or simulate lookups</p>
              </div>
              <button
                onClick={() => {
                  stopCamera();
            ...
            <div className="p-4 pb-0 bg-slate-50 border-b border-slate-100">
              <div className="grid grid-cols-2 gap-2 bg-slate-200/60 p-1 rounded-lg">
                ...
                >
                  <Sliders className="w-3.5 h-3.5 text-emerald-600" /> Manual Simulator
                </button>
              </div>
            </div>

            {/* Main scanner canvas/simulator view */}
